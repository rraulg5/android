...
import mx.raulgarcia.android.androidchat.addcontact.AddContactPresenter;
import mx.raulgarcia.android.androidchat.addcontact.AddContactPresenterImpl;
...
public class AddContactFragment extends DialogFragment implements AddContactView, DialogInterface.OnShowListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity())
                .setTitle(R.string.addcontact_msg_title)
                .setPositiveButton(R.string.addcontact_msg_add, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {

                    }
                })
                .setNegativeButton(R.string.addcontact_msg_cancel, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
    ...
    public void contactAdded() {
        Toast.makeText(getActivity(), R.string.addcontact_msg_contactadded, Toast.LENGTH_SHORT);
        dismiss();
    }
    ...
    public void contactNotAdded() {
        ...
        editTxtEmail.setError(getString(R.string.addcontact_error_msg));
    }
